...
*/
const API_KEYS = {
  KMA_SERVICE_KEY: '여기에_기상청_단기예보_API_KEY를_넣으세요',
  AIRKOREA_SERVICE_KEY: '여기에_에어코리아_대기오염정보_API_KEY를_넣으세요'
};
...
function renderConnectionError() {
  ...
  dom.summaryDetail.textContent = '예시값은 표시하지 않습니다. API 키, 브라우저 콘솔 오류, 공공데이터 응답 메시지를 확인하세요.';
